	...
	class Init{
		...
		*/
		...
		public function init(){
			$this->basePath = "http://" . $_SERVER["HTTP_HOST"] . "/zadanie3/www";
		...
		/**
		 * [checkLink skontroluje aktualnu classu a template]
		 * @param  [string] $link [string v tvare class/template]
		 * @return [bolean]       [ak je pozadovana classa a template aktualna vrati true inak false]
		 */
